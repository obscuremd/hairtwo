    ...
    <div className="relative w-full p-5 md:p-[68px] md:pt-0">
      ...
      {scrollPos > 0 && (
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 left-2 md:left-12 z-20 bg-white p-2 rounded-full shadow-md hover:scale-110 transition"
        >
      ...
      {scrollPos < maxScroll && (
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 right-2 md:right-12 z-20 bg-white p-2 rounded-full shadow-md hover:scale-110 transition"
        >
