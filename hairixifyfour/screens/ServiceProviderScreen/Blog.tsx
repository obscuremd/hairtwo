...
export default function Blog() {
  ...
  return (
    <div className="w-full p-10 md:p-[68px] mx-auto">
      <h2 className=" text-xl md:text-[2rem] font-bold mb-3">Blog</h2>
      <p className=" text-gray-500 md:text-lg mb-8 font-medium">
